...
export class TerrakubeClient {
  ...
  constructor(gitHubActionInput: GitHubActionInput) {
    this.httpClient = new httpm.HttpClient('TerrakubeClient', [], {
      ignoreSslError: gitHubActionInput.ignoreSslError
    })
  ...
  async getOrganizationId(organizationName: string): Promise<any> {
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization?filter[organization]=name==${organizationName}`
    )
  ...
  async getWorkspaceId(
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/workspace?filter[workspace]=name==${workspaceName}"`
    )
  ...
  async createWorkspace(
    ...
    core.debug(
      `POST ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/workspace`
    )
  ...
  async getTemplateId(
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/template?filter[template]=name==${templateName}`
    )
  ...
  async getSshId(organizationId: string, sshName: string): Promise<any> {
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/ssh?filter[ssh]=name==${sshName}`
    )
  ...
  async getVariableId(
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/workspace/${workspaceId}/variable?filter[variable]=key==${variableName}`
    )
  ...
  async getVariableById(
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/workspace/${workspaceId}/variable/${variableId}`
    )
  ...
  async updateVariableById(
    ...
    core.debug(
      `PATCH ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/workspace/${workspaceId}/variable/${variableId}`
    )
  ...
  async createVariable(
    ...
    core.debug(
      `POST ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/workspace/${workspaceId}/variable`
    )
  ...
  async createJobId(
    ...
    core.debug(
      `POST ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/job`
    )
  ...
  async getJobData(organizationId: string, jobId: string): Promise<any> {
    ...
    core.debug(
      `GET ${this.gitHubActionInput.terrakubeEndpoint}/api/v1/organization/${organizationId}/job/${jobId}?include=step`
    )
